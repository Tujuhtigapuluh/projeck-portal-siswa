    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden p-4">
      ...
      {role !== null && (
        <div className="absolute left-4 top-4 z-20 flex items-center gap-3">
          <button
            onClick={handleBack}
            className="p-2 rounded-lg bg-white/20 hover:bg-white/30 text-white transition-colors border border-white/30 backdrop-blur-sm"
      ...
      <div className="relative z-10 w-full max-w-5xl">
        <div className="text-center mb-0">
          <div className={`inline-flex items-center justify-center mb-5 ${role === null ? 'h-48 w-48' : 'h-20 w-20'}`}>
            <img
              ...
              className={`object-contain drop-shadow-2xl ${role === null ? 'h-44 w-44' : 'h-20 w-20'}`}
            />
          </div>
          <h1 className="text-3xl font-bold text-white drop-shadow-lg mb-0">Portal Absensi</h1>
        </div>
